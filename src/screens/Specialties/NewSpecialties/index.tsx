...
export function NewSpecialties() {

  const navigate = useNavigate();

  const [especialidade, setEspecialidade] = useState("");

  const _collectionRefUser = firebase.firestore().collection("_SPECIALTIES");
  ...
  return (
    <Container>
      ...
      <ContainerDashboard>
        <Header title={"Nova Especialidade"} />
        <BoxTitleDashboard>
          <ContTitle>
            <ActionText>Nova Especialidade</ActionText>
        ...
        <ContainerLocal>
          ...
          <ContainerButtonSave onClick={() => enviarDados()}>
            <TextButtonSave>Salvar especialidade</TextButtonSave>
          </ContainerButtonSave>
        </ContainerLocal>
      </ContainerDashboard>
    </Container>
